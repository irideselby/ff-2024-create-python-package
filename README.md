...
| |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|---|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Package | [![Latest PyPI Version](https://img.shields.io/pypi/v/fftestpackage.svg)](https://pypi.org/project/fftestpackage/) [![Supported Python Versions](https://img.shields.io/pypi/pyversions/fftestpackage.svg)](https://pypi.org/project/fftestpackage/) [![Documentation](https://readthedocs.org/projects/fftestpackage/badge/?version=latest)](https://fftestpackage.readthedocs.io/en/latest/?badge=latest)                                                                                                                                                                              |
